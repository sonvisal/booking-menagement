    ...
    <tr id='high'>
        <td data-order="<?php echo $timeslot['id']; ?>">
            ...
            <div class="pull-right">
                <a href="#" class="confirm-delete" data-id="<?php echo $timeslot['id'];?>" title="<?php echo lang('timeslots_user_tooltip_delete');?>"><i class="icon-trash icon-red"></i></a>
            </div>
        </td>
        <td><?php echo $timeslot['location_name']; ?></td>
        <td><?php echo $timeslot['room_name']; ?></td>
        <td class="status"><?php echo lang($timeslot['status_name']); ?></td>
...
<div id="frmDeleteBooking" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeleteBooking" class="btn btn-primary"><?php echo lang('timeslots_user_popup_delete_button_yes');?></a>
        <a href="#" onclick="$('#frmDeleteBooking').modal('hide');" class="btn btn-danger"><?php echo lang('timeslots_user_popup_delete_button_no');?></a>
    </div>
</div>
