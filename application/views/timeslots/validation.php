    ...
    <tr>
        <td data-order="<?php echo $timeslot['id']; ?>">
            ...
            <div class="pull-right">
                <a href="<?php echo base_url();?>timeslots/edit/<?php echo $timeslot['id']; ?>?source=timeslots/validation" title="<?php echo lang('timeslots_validation_tooltip_edit');?>"><i class="icon-edit icon-blue"></i></a>
                &nbsp;
                <a href="<?php echo base_url();?>timeslots/accept/<?php echo $timeslot['id']; ?>" title="<?php echo lang('timeslots_validation_tooltip_accept');?>"><i class="icon-ok icon-blue"></i></a>
                &nbsp;
                <a href="<?php echo base_url();?>timeslots/reject/<?php echo $timeslot['id']; ?>" title="<?php echo lang('timeslots_validation_tooltip_reject');?>"><i class="icon-remove icon-red"></i></a>
                &nbsp;
                <a href="#" class="confirm-delete" data-id="<?php echo $timeslot['id'];?>" title="<?php echo lang('timeslots_validation_tooltip_delete');?>"><i class="icon-trash icon-red"></i></a>
            </div>
        </td>
        <td><?php echo $timeslot['location_name']; ?></td>
        <td><?php echo $timeslot['room_name']; ?></td>
        <td data-order="<?php echo $tmpEndDate; ?>"><?php echo $startdate; ?></td>
        <td data-order="<?php echo $tmpStartDate; ?>"><?php echo $enddate; ?></td>
...
<div id="frmDeleteBooking" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeleteBooking" class="btn btn-primary"><?php echo lang('timeslots_validation_popup_delete_button_yes');?></a>
        <a href="#" onclick="$('#frmDeleteBooking').modal('hide');" class="btn btn-danger"><?php echo lang('timeslots_validation_popup_delete_button_no');?></a>
    </div>
</div>
