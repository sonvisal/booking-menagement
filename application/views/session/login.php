...
$this->lang->load('global', $language);?>
    ...
    <div class="row vertical-center back_ground">
        <div class="span3">&nbsp;</div>
        <!--rothna box radius-->
         <div class="form-box">
        <!--the end of rothna box radius-->
<span class="login"><?php 
$this->load->helper('html');
  echo img(lang('session_login_image'));?></span>    
...
<?php
$attributes = array('id' => 'loginFrom', 'method' => 'post');
...
<button type="button" onclick="forgotPassword()" class="btn btn-primary"><i class="icon-envelope icon-white"></i>&nbsp;<?php echo lang('session_login_button_forget_password');?></button>
  </div>
</form>
<script type="text/javascript">
    function forgotPassword(){
     
      var f = document.getElementById('loginFrom');
      f.action = "<?php echo base_url();?>session/forgetpassword";
      f.submit();
    }
