...
<style>
    ...
    <div id="upload_image_room_edit">
        <?php 
        $this->load->helper('HTML');
        if($room['image_name']!=''){?>
            <img src="<?php echo base_url().'image/'.$room['image_name'];?>" id="myImg"/>
        <?php } else {?>
...
<?php echo form_open_multipart('locations/' . $room['location_id'] . '/rooms/' . $room['id'] . '/edit') ?>
    ...
    <br />
   <?php echo form_upload(array('name'=>'pro_pic','id'=>'file_name')); ?>
