...
class Session extends CI_Controller {
    ...
    public function forgetpassword() {
        ...
        if (is_null($user)) {
            echo "UNKNOWN";
            $this->session->set_flashdata('msg',"Your login name is not exist in our system.");
            redirect(base_url());
        } else {
              $config = Array(
            		'protocol' => 'smtp',
        ...
        $this->email->set_newline("\r\n");
          //  $this->load->library('email');
           ...
           // $this->email->to('kimsan.poy@gmail.com');
            $this->email->subject(lang('email_password_forgotten_subject'));
            $this->email->message($message);
            $this->email->send();
           // echo "OK";

            $this->session->set_flashdata('msg',"Your new password has been send vai your email Please check your email inbox or spam mail.");
            redirect(base_url());
		/////////////////////////////////////////			
        }
    }
